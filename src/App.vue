    ...
    <div id="app">
        <header>
            <svg xmlns="http://www.w3.org/2000/svg" width="612" height="612" viewBox="665.573 0 612 612" class="logotype">
                ...
                <g>
                    <path fill="#181818" stroke="#a4663f" stroke-width="9" d="M1119.573 244.804l-148 307.686-148.5-307.718 148.5-85.606z" />
                    <path fill="#181818" stroke="#a4663f" stroke-width="9" d="M820.902 216.803L971.564 66.142l150.661 150.661-150.661 150.662z" />
                    <path fill="#181818" stroke="#a4663f" stroke-width="9" d="M823.073 244.772l148.5-85.606 148 85.638" />
                    <path fill="#181818" stroke="#a4663f" stroke-width="9" d="M1025.179 265.167l-53.75 102.295-54.5-102.295 54.5-48.368z" />
                    <g fill="#181818" stroke="#a4663f" stroke-width="9">
